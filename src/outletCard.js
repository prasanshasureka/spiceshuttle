...
export default class outletList extends Component{
    ...
    onPress = () => {
        if (this.state.addresses.length===1){
            this.props.navigation.navigate('screen8', {outlet: this.props.outlet, close: this.onClose, first: 'screen9', second: 'screen14', third: 'screen15', address: this.state.addresses[0]})
            ...
            <View>
                ...
                <Overlay visible={this.state.modalVisible}  closeOnTouchOutside onClose={this.onClose}       containerStyle= {{}}
                    ...
                    easing = {'fast'} >
                        ...
                        <ModalComponent navigation={this.props.navigation} outlet={this.props.outlet} onClose={this.onClose} initial = {'screen8'} first = {'screen9'} second = {'screen14'} third = {'screen15'}/>
